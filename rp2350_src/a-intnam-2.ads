...
package Ada.Interrupts.Names is
   ...
   --------------------------
   -- Interrupts for CPU 2 --
   --------------------------

   --  System tick
   TIMER0_IRQ_0_Interrupt_CPU_2      : constant Interrupt_ID := 0;
   TIMER0_IRQ_1_Interrupt_CPU_2      : constant Interrupt_ID := 1;
   TIMER0_IRQ_2_Interrupt_CPU_2      : constant Interrupt_ID := 2;
   TIMER0_IRQ_3_Interrupt_CPU_2      : constant Interrupt_ID := 3;
   TIMER1_IRQ_0_Interrupt_CPU_2      : constant Interrupt_ID := 4;
   TIMER1_IRQ_1_Interrupt_CPU_2      : constant Interrupt_ID := 5;
   TIMER1_IRQ_2_Interrupt_CPU_2      : constant Interrupt_ID := 6;
   TIMER1_IRQ_3_Interrupt_CPU_2      : constant Interrupt_ID := 7;
   PWM_IRQ_WRAP_0_Interrupt_CPU_2    : constant Interrupt_ID := 8;
   PWM_IRQ_WRAP_1_Interrupt_CPU_2    : constant Interrupt_ID := 9;
   DMA_IRQ_0_Interrupt_CPU_2         : constant Interrupt_ID := 10;
   DMA_IRQ_1_Interrupt_CPU_2         : constant Interrupt_ID := 11;
   DMA_IRQ_2_Interrupt_CPU_2         : constant Interrupt_ID := 12;
   DMA_IRQ_3_Interrupt_CPU_2         : constant Interrupt_ID := 13;
   USBCTRL_Interrupt_CPU_2           : constant Interrupt_ID := 14;
   PIO0_IRQ_0_Interrupt_CPU_2        : constant Interrupt_ID := 15;
   PIO0_IRQ_1_Interrupt_CPU_2        : constant Interrupt_ID := 16;
   PIO1_IRQ_0_Interrupt_CPU_2        : constant Interrupt_ID := 17;
   PIO1_IRQ_1_Interrupt_CPU_2        : constant Interrupt_ID := 18;
   PIO2_IRQ_0_Interrupt_CPU_2        : constant Interrupt_ID := 19;
   PIO2_IRQ_1_Interrupt_CPU_2        : constant Interrupt_ID := 20;
   IO_IRQ_BANK0_Interrupt_CPU_2      : constant Interrupt_ID := 21;
   IO_IRQ_BANK0_NS_Interrupt_CPU_2   : constant Interrupt_ID := 22;
   IO_IRQ_QSPI_Interrupt_CPU_2       : constant Interrupt_ID := 23;
   IO_IRQ_QSPI_NS_Interrupt_CPU_2    : constant Interrupt_ID := 24;
   SIO_IRQ_FIFO_Interrupt_CPU_2      : constant Interrupt_ID := 25;
   SIO_IRQ_BELL_Interrupt_CPU_2      : constant Interrupt_ID := 26;
   SIO_IRQ_FIFO_NS_Interrupt_CPU_2   : constant Interrupt_ID := 27;
   SIO_IRQ_BELL_NS_Interrupt_CPU_2   : constant Interrupt_ID := 28;
   SIO_IRQ_MTIMECMP_Interrupt_CPU_2  : constant Interrupt_ID := 29;
   CLOCKS_Interrupt_CPU_2            : constant Interrupt_ID := 30;
   SPI0_Interrupt_CPU_2              : constant Interrupt_ID := 31;
   SPI1_Interrupt_CPU_2              : constant Interrupt_ID := 32;
   UART0_Interrupt_CPU_2             : constant Interrupt_ID := 33;
   UART1_Interrupt_CPU_2             : constant Interrupt_ID := 34;
   ADC_IRQ_FIFO_Interrupt_CPU_2      : constant Interrupt_ID := 35;
   I2C0_Interrupt_CPU_2              : constant Interrupt_ID := 36;
   I2C1_Interrupt_CPU_2              : constant Interrupt_ID := 37;
   OTP_Interrupt_CPU_2               : constant Interrupt_ID := 38;
   TRNG_Interrupt_CPU_2              : constant Interrupt_ID := 39;
   PLL_SYS_Interrupt_CPU_2           : constant Interrupt_ID := 42;
   PLL_USB_Interrupt_CPU_2           : constant Interrupt_ID := 43;
   POWMAN_IRQ_POW_Interrupt_CPU_2    : constant Interrupt_ID := 44;
   POWMAN_IRQ_TIMER_Interrupt_CPU_2  : constant Interrupt_ID := 45;
   SPARE_IRQ_0_Interrupt_CPU_2       : constant Interrupt_ID := 46;
   SPARE_IRQ_1_Interrupt_CPU_2       : constant Interrupt_ID := 47;
   SPARE_IRQ_2_Interrupt_CPU_2       : constant Interrupt_ID := 48;
   SPARE_IRQ_3_Interrupt_CPU_2       : constant Interrupt_ID := 49;
   SPARE_IRQ_4_Interrupt_CPU_2       : constant Interrupt_ID := 50;
   SPARE_IRQ_5_Interrupt_CPU_2       : constant Interrupt_ID := 51;
